     ...
     <div className="glass-card rounded-2xl shadow-xl overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-8">
       ...
       <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <input name="generatorMakeModel" value={formData.generatorMakeModel} onChange={handleInputChange} placeholder="Generator Make / Model" className="dark-field-input" required />
         <input name="machineModelNumber" value={formData.machineModelNumber} onChange={handleInputChange} placeholder="Machine Model Number" className="dark-field-input" required />
         <input type="number" min="1" name="generatorCapacityKva" value={formData.generatorCapacityKva} onChange={handleInputChange} placeholder="Capacity (kVA)" className="dark-field-input" required />
        </div>
       </section>
        ...
        {formData.customerType === 'business' ? (
         <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
           ...
           <input name="machineLocationNotes" value={formData.machineLocationNotes} onChange={handleInputChange} placeholder="Machine Position Notes (e.g., Plant Room B, Bay 4, Roof Level 2)" className="dark-field-input" />
          </div>
         ...
         <>
          ...
          <input name="machineLocationNotes" value={formData.machineLocationNotes} onChange={handleInputChange} placeholder="Machine Location Notes (Optional)" className="dark-field-input" />
         </>
        )}
       </section>
       ...
       <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <select name="serviceType" value={formData.serviceType} onChange={handleInputChange} className="dark-field-input">

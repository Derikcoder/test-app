/**
 * @file SingleBusinessCustomer.jsx
 * @description Full profile view for Single Business customers.
 * Standalone SME with no parent/child account relationships.
 * Displays business info, contacts, sites, service history, and quotations.
 * Customer type: singleBusiness
 */
        ...
        {customer.sites.map((site) => (
         <div key={site._id} className="rounded-xl border border-white/15 bg-white/5 p-4 space-y-1.5">
          <div className="flex items-center justify-between gap-2">
           ...
           <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full ${site.status === 'active' ? 'bg-green-500/20 text-green-300' : 'bg-white/10 text-white/50'}`}>
            {site.status}
           </span>
          </div>
...
export default SingleBusinessCustomer;

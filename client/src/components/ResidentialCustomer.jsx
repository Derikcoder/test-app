 ...
 * @description Profile view for Residential customers.
 * Individual homeowner or tenant. Simpler profile, no business fields.
    ...
    <div className="max-w-[1000px] mx-auto">
     ...
     <div className="mb-8 flex items-center justify-between">
      <div>
       ...
       <p className="text-white/50 text-sm mt-1">{customer.customerId} · Residential</p>
      </div>
     </div>

     {/* TODO: Build out full Residential profile here */}
     <div className="glass-card p-8">
      <p className="text-yellow-300 font-semibold mb-2">🚧 Residential Profile — Shell</p>
      <p className="text-white/60 text-sm">This profile view is ready to be built out with Residential-specific fields and service history.</p>

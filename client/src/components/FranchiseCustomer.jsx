/**
 * @file FranchiseCustomer.jsx
 * @description Full profile view for Franchise customers.
 * Franchise operation linked to a Head Office. Independent billing, shared branding.
...
const FranchiseCustomer = () => {
 ...
 return (
  <CustomerProfileLayout
   ...
   badge={<span className="text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-400/30">Franchise</span>}
  meta={createBusinessProfileMeta({
   customer,
   variantLabel: 'Franchise',
   parentName,
   parentId,
   navigate,
  })}
...
export default FranchiseCustomer;
